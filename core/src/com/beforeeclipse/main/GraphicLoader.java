...
public class GraphicLoader {
    ...
    public GraphicLoader(){
        el_count = 0;
        Gdx.app.log("Debug","INIT Graphic Loadeer");
    }
    ...
    public void load_grapfSet(String name){
        ...
        Gdx.app.log("Debug","Opening grafpack '"+filename+"'");
        FileHandle file = Gdx.files.internal(filename);
        try {
            output = file.readString();
        }catch (GdxRuntimeException e){
            Gdx.app.log("Debug","Error: "+e.getMessage());
            return;
        }
        ...
        for(int i=0;i<lines.length;i++){
            ...
            if(line.startsWith("count:")){
                ...
                names = new String[el_count];
                for (int k=0; k<el_count; k++ ){
                    types[k]="UNKNOWN";
                }

                Gdx.app.log("Debug","Element count:'"+el_count+"'");
                continue;
            }
            if(line.startsWith("el:")){
                temp = line.split(":");
                String temp_type=temp[2];
                String temp_name=temp[3];

                Gdx.app.log("Debug","Element:'"+temp[1]+"' : '"+temp_type+"' : '"+temp_name+"'");
                ...
                for(int k=0; k<temp.length;k++){
                    ...
                    if(index<0 || index>el_count){
                        Gdx.app.log("Debug","Значение элемента вне диапазона :'"+index+"'");
                        continue;
                    }
                    types[index]=temp_type;
                    names[index]=temp_name;
            ...
            Gdx.app.log("Debug","Unrecognized!!! '"+line+"'");
        }
        ...
        for (int i=0; i<el_count;i++){
            ...
            try {
                ...
                Gdx.app.log("Debug","Error loading file '"+filename+"' "+e.getMessage());
            }
        }
    ...
    public int get_id_by_name(String name) {
        ...
        Gdx.app.log("Debug","Файл с таким именем ["+name+"] - не загружен ");
        return -1;
    }
    ...
    public int get_id_by_type(String type) {
        ...
        Gdx.app.log("Debug","Файл с таким типом ["+type+"] - не загружен ");
        return -1;
    }
